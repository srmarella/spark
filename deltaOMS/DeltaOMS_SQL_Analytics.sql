...
-- https://databrickslabs.github.io/delta-oms/
...
-- MAGIC %sql
-- MAGIC CREATE WIDGET TEXT dbname DEFAULT "oms_test_sep1"
...
FROM $dbname.commitinfosnapshots
WHERE path="abfss://regular@qaspldatalake.dfs.core.windows.net/database/dl_newc_regular/dbo_loansuffixsalestaxoption" -- <TABLE_PATH>
...
FROM $dbname.commitinfosnapshots
WHERE clusterId="1006-053138-boa690"
GROUP BY path
LIMIT 10
